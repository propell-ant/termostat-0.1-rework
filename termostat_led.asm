...
_ScanKbd:
; .FSTART _ScanKbd
; 0001 0048     switch (byScanState)
	LDS  R30,_byScanState
; 0001 0049     {
; 0001 004A         case ST_WAIT_KEY:
	CPI  R30,0
	BRNE _0x20007
; 0001 004B             // Если обнаружено нажатие на клавишу, то переходим к ее проверке.
; 0001 004C             if (KeyCode != 0)
	RCALL SUBOPT_0x8
	BREQ _0x20008
; 0001 004D             {
; 0001 004E                 byCheckedKey = KeyCode;
	RCALL SUBOPT_0x8
	STS  _byCheckedKey,R30
; 0001 004F 
; 0001 0050                 byCheckKeyCnt = PRESS_CNT;
	RCALL SUBOPT_0x9
; 0001 0051 
; 0001 0052                 byScanState = ST_CHECK_KEY;
	LDI  R30,LOW(1)
...
_0x20008:
	RJMP _0x20006
; 0001 0055 
; 0001 0056         case ST_CHECK_KEY:
_0x20007:
	CPI  R30,LOW(0x1)
	BRNE _0x20009
; 0001 0057             // Если клавиша удердивалась достаточно долго, то
; 0001 0058             // генерируем событие с кодом клавиши, и переходим к
; 0001 0059             // ожиданию отпускания клавиши
; 0001 005A             if (byCheckedKey == KeyCode)
	RCALL SUBOPT_0x8
	LDS  R26,_byCheckedKey
	CP   R30,R26
	BRNE _0x2000A
; 0001 005B             {
; 0001 005C                 byCheckKeyCnt--;
	RCALL SUBOPT_0xA
	RCALL SUBOPT_0xB
; 0001 005D                 if (!byCheckKeyCnt)
	BRNE _0x2000B
; 0001 005E                 {
; 0001 005F                     btKeyUpdate = TRUE;
	SBI  0x13,0
; 0001 0060                     byKeyCode = byCheckedKey;
	LDS  R30,_byCheckedKey
	STS  _byKeyCode,R30
; 0001 0061                     byScanState = ST_RELEASE_WAIT;
	LDI  R30,LOW(2)
	STS  _byScanState,R30
; 0001 0062                     byCheckKeyCnt = RELEASE_CNT;
	RCALL SUBOPT_0x9
; 0001 0063                     byIterationCounter = PRESS_CNT * 20;
	LDI  R30,LOW(80)
	STS  _byIterationCounter,R30
; 0001 0064                 }
; 0001 0065             }
_0x2000B:
; 0001 0066             // Если данные неустойчитывы, то возвращается назад,
; 0001 0067             // к ожиданию нажатия клавиши
; 0001 0068             else
	RJMP _0x2000E
_0x2000A:
; 0001 0069                 byScanState = ST_WAIT_KEY;
	RCALL SUBOPT_0x7
; 0001 006A             break;
_0x2000E:
	RJMP _0x20006
; 0001 006B 
; 0001 006C         case ST_RELEASE_WAIT:
_0x20009:
	CPI  R30,LOW(0x2)
	BRNE _0x20006
; 0001 006D             // Пока клавиша не будет отпущена на достаточный интервал
; 0001 006E             // времени, будем оставаться в этом состоянии
; 0001 006F             if (KeyCode != 0)
	RCALL SUBOPT_0x8
	BREQ _0x20010
; 0001 0070             {
; 0001 0071                 byCheckKeyCnt = RELEASE_CNT;
	RCALL SUBOPT_0x9
; 0001 0072                 if (!byIterationCounter)
	LDS  R30,_byIterationCounter
	CPI  R30,0
	BRNE _0x20011
; 0001 0073                 {
; 0001 0074                   byIterationCounter = PRESS_CNT * 2;
	LDI  R30,LOW(8)
	STS  _byIterationCounter,R30
; 0001 0075                   btKeyUpdate = TRUE;
	SBI  0x13,0
; 0001 0076                 }
; 0001 0077                 byIterationCounter--;
_0x20011:
	LDS  R30,_byIterationCounter
	SUBI R30,LOW(1)
	RJMP _0x20031
...
_0x20010:
; 0001 007A             {
; 0001 007B                 byCheckKeyCnt--;
	RCALL SUBOPT_0xA
	RCALL SUBOPT_0xB
; 0001 007C                 if (!byCheckKeyCnt)
	BRNE _0x20015
; 0001 007D                 {
; 0001 007E                     byScanState = ST_WAIT_KEY;
	RCALL SUBOPT_0x7
; 0001 007F                     byIterationCounter = PRESS_CNT * 20;
	LDI  R30,LOW(80)
_0x20031:
	STS  _byIterationCounter,R30
; 0001 0080                 }
...
; 0001 0083     }
_0x20006:
; 0001 0084     if( btKeyUpdate )
	SBIS 0x13,0
	RJMP _0x20016
; 0001 0085     {
; 0001 0086       btKeyUpdate = FALSE;
	CBI  0x13,0
; 0001 0087       ProcessKey();
	RCALL _ProcessKey
; 0001 0088     }
; 0001 0089 }
_0x20016:
...
_ProcessKey:
; .FSTART _ProcessKey
; 0001 0092     switch (byKeyCode)
	LDS  R30,_byKeyCode
; 0001 0093     {
; 0001 0094         case KEY_1:                 // Была нажата клавиша Минус
	CPI  R30,LOW(0x1)
	BRNE _0x2001C
; 0001 0095             switch (View)
	MOV  R30,R2
; 0001 0096             {
; 0001 0097               #ifdef ENTER_SETTINGS_BY_ONE_KEY
; 0001 0098               case 0:               //если был режим "Текущая температура", то
; 0001 0099                  View = SHOW_TLoadOn;           //переходим в режим "Установленная температура"
; 0001 009A               break;
; 0001 009B               #endif
; 0001 009C               case SHOW_TLoadOn:               //если мы в режиме "Установленная температура", то
	CPI  R30,LOW(0x1)
	BRNE _0x20020
; 0001 009D                 if (T_LoadOn > TLoadOn_Min) //если "Установленная температура" > Min, то
	LDI  R30,LOW(64986)
	LDI  R31,HIGH(64986)
	CP   R30,R6
	CPC  R31,R7
	BRGE _0x20021
; 0001 009E                 {
; 0001 009F                   T_LoadOn -= T_STEP;      //уменьшаем значение на 0,1°
	MOVW R30,R6
	SBIW R30,1
	MOVW R6,R30
; 0001 00A0 //                  RefreshDisplay(); //обновляем данные на экране
; 0001 00A1                 }
; 0001 00A2                 #if T_STEP > 1
; 0001 00A3                 if (T_LoadOn < TLoadOn_Min) //если "проскочили" минимальную температуру, то
; 0001 00A4                 {
; 0001 00A5                   T_LoadOn = TLoadOn_Min;      //устанавливаем минимум
; 0001 00A6                 }
; 0001 00A7                 #endif
; 0001 00A8 //                View = SHOW_TLoadOn;           //удерживаем в режиме "Установленная температура"
; 0001 00A9 //                Counter = 5;        //и взводим счётчик на 5 секунд.
; 0001 00AA               break;
_0x20021:
	RJMP _0x2001F
; 0001 00AB               case 2:               //если мы в режиме "Дэльта", то
_0x20020:
	CPI  R30,LOW(0x2)
	BRNE _0x2001F
; 0001 00AC                 if (DeltaT > DeltaT_Min)     //если "Дэльта" больше Min, то
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R8
	CPC  R31,R9
	BRGE _0x20023
; 0001 00AD                 {
; 0001 00AE                   DeltaT --;        //уменьшаем Дэльту на 0,1°
	MOVW R30,R8
	SBIW R30,1
	MOVW R8,R30
; 0001 00AF //                  RefreshDisplay(); //обновляем данные на экране
; 0001 00B0                 }
; 0001 00B1 //                Counter = 5;        //и взводим счётчик ещё на 5 секунд.
; 0001 00B2               break;
_0x20023:
; 0001 00B3               #ifdef CorCode
; 0001 00B4               case 3:                   //если мы в режиме "Коррекции", то
; 0001 00B5                 if (CorT > CorT_Min)
; 0001 00B6                 {
; 0001 00B7                     CorT--;         //уменьшаем значение на 0,1°
; 0001 00B8                 }
; 0001 00B9                 break;
; 0001 00BA               #endif
; 0001 00BB             }
...
; 0001 00BC         break;
	RJMP _0x2001B
; 0001 00BD 
; 0001 00BE         case KEY_2:                 // Была нажата клавиша Плюс
_0x2001C:
	CPI  R30,LOW(0x2)
	BRNE _0x20024
; 0001 00BF             switch (View)
	MOV  R30,R2
; 0001 00C0             {
; 0001 00C1               #ifdef ENTER_SETTINGS_BY_ONE_KEY
...
; 0001 00C4               break;
; 0001 00C5               #endif
; 0001 00C6               case SHOW_TLoadOn:               //если мы в режиме "Установленная температура", то
	CPI  R30,LOW(0x1)
	BRNE _0x20028
; 0001 00C7                 if (T_LoadOn < (TLoadOn_Max - DeltaT))    //если температура ниже Max - Дельта
	...
	BRGE _0x20029
; 0001 00C8                 {
; 0001 00C9                   T_LoadOn += T_STEP;      //то увеличиваем Установленную температуру на 0,1°
	MOVW R30,R6
	ADIW R30,1
	MOVW R6,R30
; 0001 00CA //                  RefreshDisplay(); //обновляем данные на экране
; 0001 00CB                 }
; 0001 00CC                 #if T_STEP > 1
; 0001 00CD                 if (T_LoadOn > TLoadOn_Max - DeltaT) //если "проскочили" максимальную температуру, то
; 0001 00CE                 {
; 0001 00CF                   T_LoadOn = TLoadOn_Max - DeltaT;      //устанавливаем максимум
; 0001 00D0                 }
; 0001 00D1                 #endif
; 0001 00D2 //                View = SHOW_TLoadOn;           //удерживаем в режиме "Установленная температура"
; 0001 00D3 //                Counter = 5;        //и взводим счётчик ещё на 5 секунд.
; 0001 00D4               break;
_0x20029:
	RJMP _0x20027
; 0001 00D5               case 2:
_0x20028:
	CPI  R30,LOW(0x2)
	BRNE _0x20027
; 0001 00D6                 if (DeltaT < DeltaT_Max)   //если Дельта меньше Max, то
	LDI  R30,LOW(250)
	LDI  R31,HIGH(250)
	CP   R8,R30
	CPC  R9,R31
	BRGE _0x2002B
; 0001 00D7                 {
; 0001 00D8                   DeltaT ++;        //то увеличиваем Дэльту на 0,1°
	MOVW R30,R8
	ADIW R30,1
	MOVW R8,R30
; 0001 00D9 //                  RefreshDisplay(); //обновляем данные на экране
; 0001 00DA                 }
; 0001 00DB //                Counter = 5;        //и взводим счётчик ещё на 5 секунд.
; 0001 00DC               break;
_0x2002B:
; 0001 00DD               #ifdef CorCode
; 0001 00DE               case 3:                   //если мы в режиме "Коррекции", то
; 0001 00DF                 if (CorT < CorT_Max)
; 0001 00E0                 {
; 0001 00E1                     CorT++;
; 0001 00E2                 }
; 0001 00E3               break;
...
; 0001 00E6         break;
	RJMP _0x2001B
; 0001 00E7 
; 0001 00E8         case KEY_3:               // Была нажаты обе кноки вместе.
_0x20024:
	CPI  R30,LOW(0x3)
	BRNE _0x2002E
; 0001 00E9           View++;
	INC  R2
; 0001 00EA           if (View > View_Max)
	LDI  R30,LOW(3)
	CP   R30,R2
	BRSH _0x2002D
; 0001 00EB           {
; 0001 00EC             View = SHOW_TLoadOn;
	LDI  R30,LOW(1)
	MOV  R2,R30
; 0001 00ED           }
; 0001 00EE //             switch (View)
; 0001 00EF //             {
; 0001 00F0 //               case 0:               //если был режим "Текущая температура", то
; 0001 00F1 //                 View = SHOW_TLoadOn;           //переходим в режим "Установленная температура"
; 0001 00F2 //               break;
; 0001 00F3 //               case 1:               //если мы в режиме "Установленная температура", то
; 0001 00F4 //                 View = SHOW_DeltaT;           //удерживаем в режиме "Дэльта"
; 0001 00F5 //               break;
; 0001 00F6 //               case 2:
; 0001 00F7 //                 View = SHOW_Error;           //переходим в режим "Последняя обнаруженная ошибка"
; 0001 00F8 //               break;
; 0001 00F9 //               case 3:
; 0001 00FA //                 View = SHOW_TLoadOn;           //переходим в режим "Установленная температура"
; 0001 00FB //               break;
; 0001 00FC //             }
; 0001 00FD //             Counter = 5;        //и взводим счётчик на 5 секунд.
; 0001 00FE //             Counter = 5;        //и взводим счётчик ещё на 5 секунд.
; 0001 00FF //             Counter = 5;        //и взводим счётчик ещё на 5 секунд.
; 0001 0100 //            Counter = 5;        //и взводим счётчик ещё на 5 секунд.
; 0001 0101         break;
_0x2002D:
; 0001 0102 
; 0001 0103         default:
...
; 0001 0106     }
_0x2001B:
; 0001 0107     Counter = COUNTER_MAX;        //и взводим счётчик ещё на 5 секунд.
	LDI  R30,LOW(5)
	MOV  R3,R30
; 0001 0108     #ifdef Blinking
; 0001 0109     GoBlinking = 0;
	CBI  0x14,0
; 0001 010A     #endif
; 0001 010B     RefreshDisplay(); //обновляем данные на экране
	RCALL _RefreshDisplay
; 0001 010C 
; 0001 010D }
	RET
