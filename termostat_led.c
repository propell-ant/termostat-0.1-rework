...
// Declare your local variables here
        ...
        DDRB= 0b00001100; // клавиши управления (регистры 4 и 5) работают на вход, регистры 2 и 3 - на выход, отвечают за нагрузку
        ...
        #ifdef Cathode  
          PORTC=0b00001111; // разряды индикатора (PORTС.0,.1,.2,.3) поднять
          DDRC= 0b00001111; // регистры разрядов индикатора работают на выход

        #endif       
        #ifdef Anode  
          PORTC=0b00000000; // разряды индикатора (PORTС.0,.1,.2,.3) опустить
          DDRC= 0b00001111; // регистры разрядов индикатора работают на выход
        #endif
